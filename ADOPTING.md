...
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" init --target . --yes
```
...
```bash
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" status --target .
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" update --target . --yes
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" validate --target .
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" doctor --target .
```
...
```bash
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" plan --target . --migrate-instructions
npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" init --target . --migrate-instructions --yes
```
...
```bash
npm exec --yes --package="github:wtulloch/harness-starter-kit#v0.7.1" -- starter-harness plan --target .
```
...
1. Plan and initialize the `full` profile with the same pinned package version:
   ...
   ```bash
   npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" plan --target . --profile full
   npx --yes "github:wtulloch/harness-starter-kit#v0.7.1" init --target . --profile full --yes
   ```
